...
def process_song_file(cur, filepath):
    """
    function to process songs files and insert selected columns into the database
...
def process_log_file(cur, filepath):
    """
    function to process log files and insert selected columns into the corresponding database
    cur: cursor reference
    filepath: full file path
    """
    # open log file
