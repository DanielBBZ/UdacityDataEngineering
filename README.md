...
Link: [Data_Modeling_with_Postgres](https://github.com/)
...
Link : [Data_Modeling_with_Apache_Cassandra](https://github.com/)
...
Use Redshift IaC script - [Redshift_IaC_README](https://github.com/)

Link  - [Data_Warehouse](https://github.com/)
...
Link: [Data_Lake](https://github.com/s)
...
Link:  [Airflow_Data_Pipelines](https://github.com/)
...
Link: [API to Postgres](https://github.com/)
...
Here is the link - [goodreads_etl_pipeline](https://github.com/)
